...
class Navi extends Component {
    ...
    if (this.state.is_admin) {
      return (
        <Tooltip title="Opcje">
          <IconButton
            color="primary"
            onClick={() => this.setRedirection("admin_settings")}
          >
            <SettingsIcon />
          </IconButton>
        </Tooltip>
  ...
  addArt() {
    ...
    if (
      this.props.location !== "/issue/create/" &&
      !this.beginsWith(this.props.location)
    ) {
      return (
        ...
        <div className="navi">
          ...
          >
            <Tooltip title="Strona główna">
              <IconButton
                color="primary"
                onClick={() => this.setRedirection("home")}
              >
                <HomeIcon />
              </IconButton>
            </Tooltip>
